...
method: searched
source: https://docs.cdp.coinbase.com/cdp-cli/skill.md
name: cdp-setup
description: Install the Coinbase Developer Platform (CDP) CLI, configure API key + wallet secret from the Coinbase Developer Portal, verify connectivity, and optionally wire the cdp MCP server.
api: https://docs.cdp.coinbase.com
official: true
operations:
  - cdp env live
  - cdp evm accounts list
  - cdp evm accounts create
  - cdp evm faucet
  - cdp mcp
  - cdp skills add
---

<!-- Verbatim provider-published Agent Skill, retrieved 2026-07-18 from https://docs.cdp.coinbase.com/cdp-cli/skill.md -->
...
4. **Create a CDP project and API key**:
   ...
   > Go to [https://portal.cdp.coinbase.com/api-keys/secret](https://portal.cdp.coinbase.com/api-keys/secret)
   >
...
5. **Generate a wallet secret** (required for non-custodial wallet operations):

   > Go to [https://portal.cdp.coinbase.com/wallets/non-custodial/security](https://portal.cdp.coinbase.com/wallets/non-custodial/security)
   >
...
7. **Quick test — create and fund an account** (optional):
   ...
   Non-custodial wallet accounts are network-agnostic — the same address works on any EVM network.
